...
def process_room_launch_message(
    *,
    ...
    receipt = persist_ingress_receipt(
        {
            **base_receipt,
            ...
            "mentioned_handles": mentioned_handles,
            "qualified_handle": qualified_handle,
            "targets": [{**target_identity, "session_name": target_selector, "status": "pending"}],
        }
    )
    ...
    try:
        ...
        receipt["targets"] = [{**target_identity, "session_name": target_selector, "status": "failed", "error": str(exc)}]
        receipt = persist_ingress_receipt(receipt)
        return {"status": "failed", "ingress_id": ingress_id, "receipt": receipt}
    receipt["status"] = "delivered"
    receipt["targets"] = [{**target_identity, "session_name": target_selector, "status": "delivered", "response": response}]
    receipt = persist_ingress_receipt(receipt)
